...
import { Mail, Phone, MessageSquare, MapPin, User, Send } from "lucide-react"
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600">
                        Be it installation, consultation, or support — we’re ready to power
                        your journey.
                    </p>
                </motion.div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <User className="absolute left-3 top-3 w-5 h-4 text-gray-400" />
                                            <Input
                                                type="text"
                                                name="name"
                                                value={formData.name}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Mail className="absolute left-3 top-3 w-5 h-4 text-gray-400" />
                                            <Input
                                                type="email"
                                                name="email"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Phone className="absolute left-3 top-3 w-5 h-4 text-gray-400" />
                                            <Input
                                                type="tel"
                                                name="phone"
